  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-white/[0.02] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] mb-10 backdrop-blur-md">
      ...
      <div className="relative z-10 p-6 sm:p-10 lg:p-12 max-w-4xl">
        ...
        {/* Featured Tag */}
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-[10px] font-mono tracking-widest uppercase mb-4 backdrop-blur-md">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8 text-xs font-mono text-slate-300">
          <span className="px-3 py-1 rounded-md bg-white/[0.04] border border-white/10 text-cyan-300 flex items-center gap-1.5">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          {game.trailerUrl && (
            <button
              ...
              className="px-5 py-3.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-white font-bold text-xs uppercase tracking-wider border border-white/10 hover:border-cyan-500/30 transition-all flex items-center gap-2 cursor-pointer"
            >
